...
\vspace{-.5em}
- For publicly available data this generally received very little formal review
...
\vspace{.15cm}
You are not expected to come a "correct conclusion" in this question; rather, you will be graded based on identifying relevant principles of free and informed consent and considering them with respect to the prompt in a sensible manner that demonstrates that you understand them.
...
- Whhat does it mean for an algorithm to have built-in biases?
